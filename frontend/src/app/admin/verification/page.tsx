    ...
    return (
      <main className="min-h-screen bg-[var(--background)] px-4 py-10 sm:px-6 lg:px-8">
        <Card className="mx-auto max-w-xl p-8 text-center">
          <h1 className="text-3xl font-black">Akses verifikasi dibatasi</h1>
          <p className="mt-3 text-[var(--muted)]">
            Login sebagai petugas untuk memverifikasi laporan warga.
          </p>
  ...
  return (
    <AdminShell currentUser={currentUser}>
      <main className="min-h-screen px-4 py-6 sm:px-6 lg:px-8">
        <AdminReportsTable initialReports={reports} mode="verification" />
      </main>
    </AdminShell>
  );
}
